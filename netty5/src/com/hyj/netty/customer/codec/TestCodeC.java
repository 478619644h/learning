...
public class TestCodeC {
    ...
    CustomerMarshallingEncoder marshallingEncoder;
    CustomerMarshallingDecoder marshallingDecoder;

    public TestCodeC() throws IOException {
        marshallingDecoder = new CustomerMarshallingDecoder();
        marshallingEncoder = new CustomerMarshallingEncoder();
    }
    ...
    public NettyMessage getMessage() {
        ...
        for (int i = 0; i < 10; i++) {
            attachment.put("ciyt --> " + i, "lilinfengsdfasdfasdfasddddddddddddddddddddddddddddddddddddddddddddddfwefaewfaefa " + i);
        }
